  ...
  return (
    <Grid container xs={12} justify="center">
      <Grid item xs={6}>
        ...
        <div>
          {notRevived.map((candidate, i) => (
            <CandidateMiniCard key={i} timeZon={timeZon} candidate={candidate} />
          ))}
        </div>
      </Grid>
      <Grid item xs={6}>
