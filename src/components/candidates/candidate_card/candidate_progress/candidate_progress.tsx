...
function getSteps() {
    return ['An interview with HR is scheduled', 'An interview with HR is finished', 'The level of English is checked', 'An interview with TS is scheduled', 'An interview with TS is finished'];
}
