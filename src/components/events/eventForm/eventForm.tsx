...
const EventForm: FunctionComponent<TEventForm> = ({ eventId, eventType, isEditMode, eventData }) => {
  ...
  const onEventFormSubmit = (data: IEventForm) => {
    ...
    eventType === 'new' && eventsApi.createEvent(data);
    eventType === 'info' && eventId && eventsApi.updateEvent(eventId, data);
  };
              ...
              render={({ field }) => {
                return (
                  <TextareaAutosize
                    ...
                    className={`${classes.full_width} ${!!errors.body && classes.error_field} ${readOnly && classes.disabled_field}`}
                    disabled={readOnly}
                  />
                );
              }}
                ...
                render={({ field }) => {
                  return (
                    <Select
                      ...
                      label="English level"
                      className={`${!!errors.englishLevel && classes.error_field} ${readOnly && classes.disabled_field}`}
                      disabled={readOnly}
                    >
              ...
              render={() => {
                return (
                  <Autocomplete
                    ...
                    className={`${!!errors.technologies && classes.error_field} ${readOnly && classes.disabled_field}`}
                    disabled={readOnly}
              ...
              render={({ field }) => {
                return (
                  <TextField
                    ...
                    className={`date_field ${!!errors.startDate && classes.error_field} ${readOnly && classes.disabled_field}`}
                    disabled={readOnly}
                  />
                );
              }}
                ...
                render={({ field }) => {
                  return (
                    <TextField
                      ...
                      className={`date_field ${!!errors.deadline && classes.error_field} ${readOnly && classes.disabled_field}`}
                      disabled={readOnly}
                    />
                  );
                }}
                ...
                render={({ field }) => {
                  return (
                    <TextField
                      ...
                      className={`date_field ${!!errors.dateOfEndAccept && classes.error_field} ${readOnly && classes.disabled_field}`}
                      disabled={readOnly}
                    />
                  );
                }}
